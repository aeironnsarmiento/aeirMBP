...
/**
 * The rejection shape (R2, R3, R7). The 405 and preflight these probes cover
 * are framework-generated; what is under test is that exporting every verb
 * takes them off the table, and that no probe can tell one refusal from
 * another or from a route this app does not handle.
 */

...
/**
 * The visitor's only control over the site's appearance (R9, R10).
 *
 * Renders both icons and lets CSS decide which is visible, so the button never
 * branches on a client-only value and cannot mismatch during hydration.
 */
